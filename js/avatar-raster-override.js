/* ViCamBachGiai — approved raster avatar pool override. */
(function(){
  ...
  const ASSETS=(window.VICAM_DEMO_AVATAR_ASSETS||[]).slice(0,16);
  if(ASSETS.length<16)return;
  ...
  window.VICAM_AVATARS={options:OPTIONS,assets:ASSETS,srcByIndex,srcFor,decorate,sync,indexFor};
